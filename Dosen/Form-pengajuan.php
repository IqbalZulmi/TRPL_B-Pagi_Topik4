        ...
        <div class="container-fluid">
          ...
          <div class="row bg-light my-3 mx-0 border border-dark border-opacity-25">
            ...
            <?php include 'koneksi.php';
                ...
                $sql = "SELECT * FROM dosen where username='$abc'";
              ...
              <form class="form-horizontal" method="post" action="input_pengajuan.php">
                ...
                <div class="form-group">
                  <div class="row my-2">
                    <label for="nim" class="col-sm-4 control-label">NIDN</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" placeholder="NIDN" name="nim" value="<?php echo $form['nidn'];?>" readonly required/>
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row my-2">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" name="nama_mahasiswa" placeholder="Nama" value="<?php echo $form['nama_dosen'];?>" readonly required/>
                    </div>
                  </div>
                </div>
                <div class="form-group">
