        ...
        <div class="container-fluid">
          <div class="row bg-light my-2 mx-0 border border-dark border-opacity-25">
            <div class="col-12 p-1 ps-2">
              <h1 id="dash">Verifikasi Peminjaman</h1>
            </div>
          </div>
          <?php
          ...
          <div class="row bg-light my-3 mx-0 border border-dark border-opacity-25">
            <div class="col-12 table-responsive-md mt-1">
              ...
              <tbody>
                ...
                $sql = "SELECT * FROM peminjaman where status ='pending'";
                $query = mysqli_query($db, $sql);
                while ($form = mysqli_fetch_array($query)) {
                ?>
                <tr>
                  <td><?php echo $form['no_identitas'];?></td>
                  <td><?php echo $form['nama'];?></td>
                  <td><?php echo $form['anggota'];?></td>
                  <td><?php echo $form['keperluan'];?></td>
                  <td><?php echo $form['kode_ruangan'];?></td>
                  <td><?php echo $form['dosen_penanggung_jawab'];?></td>
                  <td><?php echo $form['hari'];?></td>
                  <td><?php echo $form['tanggal_peminjaman'];?></td>
                  <td><?php echo $form['jam_pinjaman_awal'];?></td>
                  <td><?php echo $form['jam_pinjaman_akhir'];?></td>
                  <td>
                  ...
                  <td>
                      <input type="submit" name="submit" class="btn btn-sm btn-primary" value="kirim">
                    </form>
                  </td>
                </tr>
                <?php
