...
$sql = "SELECT * FROM ruangan WHERE kode_ruangan='$koderuangan'";
            ...
            <div class="container-fluid">
                <div class="row bg-light my-2 mx-0 border border-dark border-opacity-25">
                    <div class="col-12 p-1 ps-2">
                        <h1 id="dash">Edit Data Ruangan</h1>
                    </div>
                </div>
                <div class="row bg-light my-3 mx-0 border border-dark border-opacity-25">
                    <div class="col-12 text-center mt-1">
                        ...
                        <b>
                            <h4 class="text-center font-weight-bold mr-4">Halaman Admin Edit Data Ruangan</h4>
                        </b>
                        ...
                        <form action="edit_ruangan.php" method="post" enctype="multipart/form-data">
                            <div class="mb-3 row">
                                <label for="kode_ruangan" class="col-sm-2 col-form-label">Kode Ruangan</label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="kode_ruangan" value="<?php echo $ruangan['kode_ruangan'] ?>" required/>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="nama_ruangan" class="col-sm-2 col-form-label">Nama Ruangan</label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="nama_ruangan" value="<?php echo $ruangan['nama_ruangan'] ?>" required/>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="lokasi" class="col-sm-2 col-form-label">Lokasi</label>
                                <?php $lokasi = $ruangan['lokasi']; ?>
                                <div class="col-sm-7">
                                    <select name="lokasi" size="1" class="form-control" required>
                                        <option <?php echo ($ruangan == 'Gedung Utama') ? "selected": "" ?>>Gedung Utama</option>
                                        <option <?php echo ($ruangan == 'Tower A') ? "selected": "" ?>>Tower A</option>
                                        <option <?php echo ($ruangan == 'Gedung RTF') ? "selected": "" ?>>Gedung RTF</option>
                                        <option <?php echo ($ruangan == 'Technopreneur') ? "selected": "" ?>>Technopreneur</option>
                                    </select>
                                </div>
                            </div>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-7">
                                    <select name="status" size="1" class="form-control" required>
                                        <option <?php echo ($ruangan == 'available') ? "selected": "" ?>>available</option>
                                        <option <?php echo ($ruangan == 'not available') ? "selected": "" ?>>not available</option>
                                    </select>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="day" value="<?php echo $ruangan['hari'] ?>" required/>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="foto" class="col-sm-2 col-form-label">Foto</label>
                                <div class="col-sm-7">
                                    <input type="file" class="form-control" name="foto" value="<?php echo $ruangan['foto'] ?>" required/>
                                </div>
                            </div>
                            <div class="mb-3 row">
