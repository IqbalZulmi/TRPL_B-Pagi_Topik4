<html lang="en">
	...
	?>
        ...
        <div class="main-content all-content-wrapper ">
                ...
                $query= mysqli_query($db,"SELECT * FROM `laboran` WHERE `username` LIKE '%$abc%' ");
                    ...
                    <div class="col-sm-5 my-2 mt-5">
                        ...
                        <form action="edit-profil.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" class="form-control" id="exampleFormControlInput" value="<?php echo $data['nama_laboran'];?>" disabled readonly required>
                            </div>
                            <div class="mb-3">
